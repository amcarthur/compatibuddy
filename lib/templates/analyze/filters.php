    ...
    <div class="compatibuddy-tree-top">
        ...
        <div class="compatibuddy-tree-top-item compatibuddy-sorting">
            <form class="compatibuddy-tree-sort">
                <label class="compatibuddy-tree-top-item-heading" for="compatibuddy-filters-tree-sort-by">Sort By</label>
                <div class="compatibuddy-flex-inputs">
                    <div class="compatibuddy-flex-input-left">
                    ...
                    <div class="compatibuddy-flex-input-right">
                        <label>
                            <input type="radio" name="compatibuddy-tree-sort-order" class="compatibuddy-order" value="asc" checked /> Asc
                        </label>
                    </div>
                    <div class="compatibuddy-flex-input-right">
                        <label>
                            <input type="radio" name="compatibuddy-tree-sort-order" value="desc" /> Desc
                        </label>
                    </div>
                    <div class="compatibuddy-flex-input-right">
