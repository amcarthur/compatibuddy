...
class Environment {
    ...
    protected static $filesToInclude = [
        ...
        'lib/Database.php',
        'lib/Utilities.php',
        'lib/Caches/ModuleCache.php',
        'lib/Scanners/ModuleScanner.php',
        'lib/Analyzers/FilterCallsAnalyzer.php',
        'lib/Analyzers/PrioritizedFilterCallsAnalyzer.php',
        'lib/Analyzers/ModuleAddFilterCallsAnalyzer.php',
        'lib/Analyzers/AllCallsAnalyzer.php',
        'lib/Admin.php',
